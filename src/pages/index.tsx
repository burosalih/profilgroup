      ...
      <main>
        ...
        <section className="relative h-[70vh] bg-gradient-to-br from-neutral-700 to-neutral-900 text-white flex items-center justify-center px-4">
          <div className="text-center max-w-5xl">
            <h1 className="text-4xl md:text-7xl font-extrabold mb-6 font-exo break-words whitespace-normal">
              {t('hero_title')}
            </h1>
            <p className="text-lg md:text-xl mb-8 font-light break-words whitespace-normal">
              {t('hero_subtitle')}
            </p>
            <Link href="/about">
        ...
        <section className="bg-gray-50 py-18 px-6">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-video md:aspect-[4/3]">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-br from-profil/70 via-transparent to-neutral-900 pointer-events-none" />
            </div>
          </div>
        </section>

        {/* FEATURES SECTION */}
        <section className="w-full h-[700px] md:h-[600px] bg-black text-white overflow-hidden">
